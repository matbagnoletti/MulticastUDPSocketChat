...
/**
 * Generico messaggio scambiato in una comunicazione di rete tra end-point {@link chat.host.MulticastPeer}.
 * <p>
...
public class Messaggio implements Serializable {
    ...
    /**
     * Variabile numerica che identifica la porta utilizzata dal {@link chat.host.MulticastPeer} per scambiare messaggi unicast. Essendo scelta in modo dinamico deve essere nota agli altri <code>multicastPeer</code> in modo da poter comunicare tra loro in modo diretto, al di fuori del {@link chat.host.GroupChat}.
     */
     ...
     * @param isDaGruppo indica se il messaggio proviene da {@link chat.host.GroupChat}
    ...
    public String getTimestamp() {
        return this.timestamp.format(DateTimeFormatter.ofPattern("k:mm"));
    }
