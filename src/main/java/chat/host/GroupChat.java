...
public class GroupChat {
     ...
     */
    public GroupChat(final String indirizzoMulticast, final int portaMulticast) throws IOException, CommunicationException, IllegalArgumentException {
    ...
    private synchronized NetworkInterface identificaNet() throws SocketException {
        ...
        while (interfacce.hasMoreElements()) {
            ...
            if (net.supportsMulticast() && net.getInetAddresses().hasMoreElements()) {
